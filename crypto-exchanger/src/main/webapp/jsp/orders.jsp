...
<main class="py-5">
    <div class="container d-lg-flex gap-4">
        ...
        <div class="account_left col-lg-3 mb-4">
            <ul class="options_list list-unstyled p-0">
                ...
                <li class="option_item mb-2">
                    <a href="/profile/KYC"
                       class="account_btn">KYC</a>
                </li>

                <li class="option_item mb-2">
                    <a href="/profile/orders"
                       class="account_btn">Сделки</a>
                </li>

                <li class="option_item mb-2">
                    <a href="/profile/wallets"
                       class="account_btn active">Кошельки</a>
                </li>
        ...
        <div class="account_right flex-fill">
            <h3 class="mb-4">Ваши сделки</h3>

            <ul class="wallets_list list-unstyled p-0">
                <c:forEach var="wallet" items="${wallets}">
                    <li class="wallet_item d-flex align-items-center p-3 mb-2 rounded">
                        <div class="wallet_icon me-3">
                            <img src="/img/${wallet.currencyCode}.png" alt="${wallet.currencyCode}" class="icon_currency">
                        </div>
                        <div class="wallet_info flex-fill">
                            ...
                            <div class="wallet_block">
                                ...
                                <div class="wallet_value copy_wallet" onclick="copyToClipboard(this)">${wallet.walletNumber}</div>
                            </div>
                        </div>
                    </li>
                </c:forEach>
...
<script>
    function copyToClipboard(element) {
        ...
        navigator.clipboard.writeText(text).then(() => {
            ...
            setTimeout(() => element.style.color = '#ddd', 1000);
        });
    }
</script>
</body>
